...
**
       ...
       :globe_with_meridians:『اوامر عامة』:globe_with_meridians:
...
●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
	  ...
	  :frame_photo:『اوامر الصور』:frame_photo:
...
if (message.content === ',support') {
      message.author.send(' |https://discord.gg/VSuFGF لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === ',invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/oauth2/authorize?client_id=441289494130458634&scope=bot&permissions=2146958591 ').catch(e => console.log(e.stack));
...
if (message.content.startsWith(',bc-users')){
 if(!message.author.id === '456522680854773760') return;
